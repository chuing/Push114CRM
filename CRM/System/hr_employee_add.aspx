...
<head id="Head1" >
    ...
    <script type="text/javascript">
        function remote1() {
            var url = "../Data_crm/hr_employee.ashx?Action=Exist&rnd=" + Math.random();
            return url;
        }
        ...
        <table class="bodytable0" border="0" cellpadding="3" cellspacing="1" 
            ...
            <tr>
                ...
                <td  class="style1" >
                    <div style="float:left; height: 20px;">
                        <input type="text" id="T_uid"   name="T_uid"    ltype="text" ligerui="{width:180}" 
                            validate="{required:true,username:true,remote:'../Data_crm/hr_employee.ashx?Action=Exist',messages:{required:'请输入账号名',remote:'此账户存在!'}}" />
                    </div>
             ...
             <tr>
                ...
                <td  class="style1" >
                        <input type="text" id="T_Position" name="T_Position"  ltype="select" ligerui="{width:180,url:'../Data_crm/hr_position.ashx?Action=combo'}"  validate="{required:true}"/>
