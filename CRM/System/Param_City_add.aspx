...
<head id="Head1" >
    ...
    <script type="text/javascript">
        ...
        function loadForm(oaid) {
            $.ajax({
                type: "GET",
                url: "../Data_crm/Param_City.ashx", /* 注意后面的名字对应CS的方法名称 */
            ...
            <tr>
                ...
                <td   >
                    <div style="float:left; height: 20px;">
                        <input type="text" id="T_Parent" name="T_Parent" ltype="select"   ligerui="{width:180,url:'../Data_crm/Param_City.ashx?Action=combo'}" validate="{required:true}" />
                    </div>                    
                </td>
            </tr>
            <tr>
