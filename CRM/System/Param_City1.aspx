...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#tree1").ligerTree({
                url: '../Data_crm/Param_City.ashx?Action=tree&rnd=' + Math.random(),
                idFieldName: 'id',
        ...
        function toolbar() {
            $.getJSON("../Data_crm/toolbar.ashx?Action=GetSys&mid=84&rnd=" + Math.random(), function (data, textStatus) {
                ...
                items.push({ type: 'button', text: '全部展开', icon: '../../img_crm/folder-open.gif', disable: true, click: function () { expandAll(1); } })
                items.push({ type: 'button', text: '全部折叠', icon: '../../img_crm/folder-closed.gif', disable: true, click: function () { collapseAll(0); } })
