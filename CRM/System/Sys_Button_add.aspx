...
<head>
    ...
    <script type="text/javascript">
        ...
        function loadForm(oaid) {
            $.ajax({
                type: "GET",
                url: "../Data_crm/Sys_Button.ashx", /* 注意后面的名字对应CS的方法名称 */
        ...
        $(".iconlist li").live('mouseover', function () {
            ...
            $("#btnicon").attr("src", "../../../img_crm/icon/" + src.split('img_crm/icon/')[1]);
            $("#T_btn_icon").val("../../../img_crm/icon/" + src.split('img_crm/icon/')[1]);
