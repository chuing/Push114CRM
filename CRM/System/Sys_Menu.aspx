...
<head>
    ...
    <script type="text/javascript">
        ...
        function toolbar() {
            $.getJSON("../Data_crm/toolbar.ashx?Action=GetSys&mid=76&rnd=" + Math.random(), function (data, textStatus) {
                var items = [];
                var arr = data.Items;
        ...
        function f_save(item, dialog) {
            ...
            if (issave) {
                ...
                $.ajax({
                    url: "../Data_crm/Sys_Menu.ashx", type: "POST",
                    data: issave,
