    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#maingrid5").ligerGrid({
                ...
                //checkbox:true,
                url: "../Data_crm/Sys_log.ashx?Action=grid",
            ...
            $("#toolbar").ligerToolBar({
                ...
                { type: 'button', text: '智能搜索', icon: '../../img_crm/search.gif', disable: true, click: function () { doserch() } },
                { type: 'button', text: '重置', icon: '../../img_crm/edit.gif', disable: true, click: function () { $("#serchform").each(function () { this.reset(); }); } }
                ]
            });



            $("#stype").ligerComboBox({ width: 100, url: "../Data_crm/Sys_log.ashx?Action=logtype" })
        ...
        function doserch() {
            ...
            manager.setURL("../Data_crm/Sys_log.ashx?" + serchtxt);
