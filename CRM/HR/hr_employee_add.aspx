    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#maingrid4").ligerGrid({
                ...
                usePager: false,
                checkbox: true,
                url: "../Data_crm/hr_post.ashx?Action=getpostbyempid&empid=" + empid,
        ...
        function loadForm(oaid) {
            $.ajax({
                type: "GET",
                url: "../Data_crm/hr_employee.ashx", /* 注意后面的名字对应CS的方法名称 */
                ...
                success: function (result) {
                   ...
                   // $("#T_uid").attr("validate", "{required:true}");
                    ...
                    $("#userheadimg").attr("src", "../img_crm/upload/portrait/" + obj.title);
        ...
        function remote() {
            var url = "../Data_crm/hr_employee.ashx?Action=Exist&emp_id=" + getparastr("empid") + "&rnd=" + Math.random();
            return url;
        }
        ...
        function saveheadimg(item, dialog) {
            ...
            if (upfile) {
                ...
                $.ajax({
                    url: "../Data_crm/upload.ashx", type: "POST",
                    data: upfile,
                    success: function (responseText) {
                        $("#headurl").val(responseText);
                        $("#userheadimg").attr("src", "../img_crm/upload/portrait/" + responseText);
            ...
            <table>
                <tr>
                    ...
                    <td width="132px" rowspan="5">
                        <img id="userheadimg" src="a.gif" onerror="noheadimg()" style="border-radius: 4px; box-shadow: 1px 1px 3px #111; width: 120px; height: 120px; margin-left: 5px; background: #d2d2f2; border: 3px solid #fff; behavior: url(../Css_crm/pie.htc);" />
