...
<head id="Head1" >
    ...
    <script type="text/javascript">
        $(function () {
            ...
            else
            {
                $("#T_position").ligerComboBox({
                    ...
                    valueField: 'id',
                    textField: 'text',
                    url: "../Data_crm/hr_position.ashx?Action=combo&companyid=0",
        ...
        function positionselected(newval){
            ...
            $.ajax({
                type: "GET",
                url: "../Data_crm/hr_position.ashx", /* 注意后面的名字对应CS的方法名称 */
        ...
        function loadForm(oaid) {
            $.ajax({
                type: "GET",
                url: "../Data_crm/hr_post.ashx", /* 注意后面的名字对应CS的方法名称 */
                ...
                success: function (result) {
                    ...
                    $("#T_position").ligerComboBox({
                        ...
                        url: "../Data_crm/hr_position.ashx?Action=combo",
                        onSelected: positionselected
                    });
                    $("#T_emp").ligerComboBox({
                        width: 390,
