...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#tree1").ligerTree({
                url: '../Data_crm/hr_department.ashx?Action=tree&companyid=0&rnd=' + Math.random(),
                onSelect: onSelect,
        ...
        function toolbar() {
            $.getJSON("../Data_crm/toolbar.ashx?Action=GetSys&mid=23&rnd=" + Math.random(), function (data, textStatus) {
                //alert(data);
                var items = [];
                var arr = data.Items;
        ...
        function onSelect(note) {
            ...
            var url = "../Data_crm/hr_post.ashx?Action=grid&depid=" + note.data.id + "&rnd=" + Math.random();
