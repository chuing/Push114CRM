    ...
    public class upload : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            if (request["Action"] == "upload")
            {
                ...
                uploadFile.SaveAs(context.Server.MapPath(@"~/img_crm/upload/temp/" + fileName));
                //this.File1.PostedFile.SaveAs(page.Server.MapPath(@"~/focusimage/" + fileName));
                context.Response.Write(@"../img_crm/upload/temp/" + fileName);
            }
            if (request["Action"] == "upheadimg")
            {
                ...
                string oldpath = page.Server.MapPath(@"~/img_crm/upload/temp/" + fileName);
                string currpath = page.Server.MapPath(@"~/img_crm/upload/portrait/" + nowfileName);
