...
<head>
    ...
    <style type="text/css">
        ...
        body { BACKGROUND: url(img_crm/login/loginbackground1.jpg) repeat-x; }
...
<body>
    <form id="form1" name="form1">
        <div style="width: 731px; margin:200px auto 0px;">
            <table id="__01" width="732" height="388" border="0" cellpadding="0" cellspacing="0">
                <tr>
                    <td rowspan="6">
                      <a href="/" target="_blank">    <img src="img_crm/logo/xhd.png" width="234" alt="XHD crm"/></a></td>
                    <td rowspan="14" style="background: url(' img_crm/login/login_02.gif') no-repeat; width: 200px; height: 279px;"></td>
                    <td colspan="7" width="187" height="54"></td>
                    <td rowspan="6" background="img_crm/login/login_04.gif" width="110" height="134"></td>
                ...
                <tr>
                    <td colspan="5" background="img_crm/login_09.jpg" width="163" height="13"></td>
                ...
                <tr>
                    ...
                    <td colspan="2" background="img_crm/login_15.gif" width="76" height="23">
                ...
                <tr>
                    <td colspan="5" background="img_crm/login_18.gif" width="97" rowspan="3">
                        <input id="login" type="button" value="登录" style="width: 80px; height: 28px;" /></td>
                    <td colspan="2" rowspan="3" background="img_crm/login_19.gif" width="90" style="height: 60px">
                ...
                <tr>
                    <td colspan="10" background="img_crm/login_25.gif" width="731" height="108"></td>
