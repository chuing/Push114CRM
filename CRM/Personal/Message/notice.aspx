    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#maingrid4").ligerGrid({
                ...
                url: "../../Data_crm/public_notice.ashx?Action=grid&rnd=" + Math.random(),
                //title:'公告列表',
        ...
        function toolbar() {
            $.getJSON("../../Data_crm/toolbar.ashx?Action=GetSys&mid=14&rnd=" + Math.random(), function (data, textStatus) {
                //alert(data);
                var items = [];
                var arr = data.Items;
                ...
                items.push({ type: 'button', text: '重置', icon: '../../img_crm/edit.gif', disable: true, click: function () { doclear() } });
        ...
        function doserch() {
            ...
            manager.setURL("../../Data_crm/public_notice.ashx?" + serchtxt);
        ...
        function del() {
            ...
            if (row) {
                $.ligerDialog.confirm("删除后不能恢复，\n您确定要删除？", function (yes) {
                    if (yes) {
                        $.ajax({
                            url: "../../Data_crm/public_notice.ashx", type: "POST",
