...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#maingrid4").ligerGrid({
                columns: [
                   ...
                   },
                   {
                       display: '����', name: 'atta_count', width: 60, render: function (item) {
                           if (item.atta_count == 0) {
                               ...
                               var html = "<img src='../../img_crm/IsAccessary.gif'/>"
                   ...
                   { display: '������', name: 'sender_name', width: 100 },
                   {
                ...
                url: "../../../Data_crm/mail.ashx?Action=recive_grid&isdel=1&rnd=" + Math.random(),
        ...
        function toolbar() {
            $.getJSON("../../../Data_crm/toolbar.ashx?Action=GetSys&mid=80&rnd=" + Math.random(), function (data, textStatus) {
                //alert(data);
                var items = [];
                var arr = data.Items;
        ...
        function doserch() {
            ...
            manager.setURL("../../../Data_crm/mail.ashx?" + serchtxt);
