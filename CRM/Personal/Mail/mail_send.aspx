    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#maingrid4").ligerGrid({
                columns: [
                    { display: '���', width: 50, render: function (item, i) { return i + 1; } },
                    {
                        display: '״̬', name: 'mail_status', width: 50, render: function (item) {
                            var html = "<img src='../../img_crm/icon/96.png' alt='�ѷ���'/>";
                            return html;
                        }
                    },
                    {
                ...
                url: "../../Data_crm/mail.ashx?Action=sender_grid&rnd=" + Math.random(),
                width: '100%',
                height: '100%',
                heightDiff: -1,
        ...
        function toolbar() {
            $.getJSON("../../Data_crm/toolbar.ashx?Action=GetSys&mid=79&rnd=" + Math.random(), function (data, textStatus) {
                var items = [];
                var arr = data.Items;
