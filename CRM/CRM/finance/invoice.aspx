...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#maingrid4").ligerGrid({
                ...
                onSelectRow: function (data, rowindex, rowobj) {
                    ...
                    var url = "../../Data_crm/CRM_invoice.ashx?Action=grid&orderid=" + data.id;
            ...
            $("#maingrid5").ligerGrid({
                ...
                //checkbox:true,
                url: "../../Data_crm/CRM_invoice.ashx?Action=grid&orderid=0&rnd=" + Math.random(),
        ...
        function toolbar() {
            ...
            $.getJSON("../../Data_crm/toolbar.ashx?Action=GetSys&mid=37&rnd=" + Math.random(), function (data, textStatus) {
                //alert(data);
                var items = [];
                var arr = data.Items;
