    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#maingrid4").ligerGrid({
                ...
                dataAction: 'server', pageSize: 50, pageSizeOptions: [20, 30, 50, 100],
                //url: "../../Data_crm/Crm_order.ashx?Action=gridorder&pass=1&issarr=1&rnd=" + Math.random(),
        ...
        function toolbar() {
            $("#toolbar").ligerToolBar({
                items: [
                    { type: 'button', text: '查看订单',  icon: '../../img_crm/folder-open.gif', disable: true, click: function () {  view();  } },
                {  type: 'serchbtn',  text: '高级搜索', icon: '../../img_crm/search.gif', disable: true, click: function () { serchpanel()  } }
                ]
            });
            menu = $.ligerMenu({
                width: 120, items:
        ...
        function initSerchForm() {
            var d = $('#contact').ligerComboBox({ width: 160, url: "../../Data_crm/Param_SysParam.ashx?Action=combo&parentid=6&rnd=" + Math.random() });
