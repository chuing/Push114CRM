...
<head>
    ...
    <script type="text/javascript">
        ...
        function toolbar(id) {
            $.getJSON("../../Data_crm/toolbar.ashx?Action=GetSys&mid=" + id + "&rnd=" + Math.random(), function (data, textStatus) {
                //alert(data);
                var items = [];
                var arr = data.Items;
        ...
        function grid() {
            g1 = $("#maingrid6").ligerGrid({
                ...
                url: "../../Data_crm/CRM_Contact.ashx?Action=grid&customerid=" + getparastr("cid"),
                width: '100%',
                height: '416',
                title: "联系人",
                heightDiff: -1
            ...
            g2 = $("#maingrid7").ligerGrid({
                ...
                //checkbox:true,
                url: "../../Data_crm/CRM_Follow.ashx?Action=grid&customer_id=" + getparastr("cid"),
            ...
            $("#maingrid35").ligerGrid({
                ...
                title: '订单详情',
                dataAction: 'local', pageSize: 30, pageSizeOptions: [20, 30, 50, 100],
                url: "../../Data_crm/Crm_order.ashx?Action=gridbycustomerid&customerid=" + getparastr("cid") + "&rnd=" + Math.random(),
                width: '100%', height: '416',
                heightDiff: -1,
                detail: {
                    onShowDetail: function (r, p) {
            ...
            $("#maingrid36").ligerGrid({
                columns: [
                  ...
                  title:'合同记录',
                dataAction: 'local', pageSize: 30, pageSizeOptions: [20, 30, 50, 100],
                url: "../../Data_crm/Crm_contract.ashx?Action=grid&cid=" + getparastr("cid") + "&rnd=" + Math.random(),
                width: '100%', height: '416',
                heightDiff: -1,                
                detail: {
                    onShowDetail: function (r, p) {
            ...
            $("#maingrid37").ligerGrid({
                ...
                dataAction: 'local', pageSize: 30, pageSizeOptions: [20, 30, 50, 100],
                //checkbox:true,
                url: "../../Data_crm/CRM_receive.ashx?Action=grid&customerid=" + getparastr("cid") + "&rnd=" + Math.random(),
                width: '100%', height: '416',
                heightDiff: -1
            });
        }
