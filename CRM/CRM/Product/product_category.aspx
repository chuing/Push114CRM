    ...
    <script type="text/javascript">
        $(function () {
            $("#maingrid4").ligerGrid({
                ...
                url: "../../Data_crm/Crm_product_category.ashx?Action=grid&grid=tree",
                width: '100%',
                height: '100%',
        ...
        function toolbar() {
            $.getJSON("../../Data_crm/toolbar.ashx?Action=GetSys&mid=44&rnd=" + Math.random(), function (data, textStatus) {
                //alert(data);
                var items = [];
                var arr = data.Items;
