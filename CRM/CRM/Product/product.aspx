        ...
        $(function () {
            ...
            $("#maingrid4").ligerGrid({
                columns: [
                    ...
                    {
                        display: '产品规格', name: 'specifications', width: 120, render: function (item) {
                    ...
                    {
                        display: '底价（￥）', name: 'base_price', width: 120, align: 'right', render: function (item) {
                            return toMoney(item.base_price);
                        }
                    },
                    { display: '单位', name: 'unit', width: 120 },
                    {
                        display: '备注', name: 'remarks', width: 120, render: function (item) {
                            var html = "<span class='showtip'>" + item.remarks + "</span>";
                            return html;
                        }
                    },
                    { display: '渠道', name: 'pway_content', width: 120 }
