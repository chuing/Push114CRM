    ...
    <script type="text/javascript">
        $(function () {
            ...
            if (getparastr("cid")) {
                ...
                var now = new Date();
                var n = "PSD" + now.getFullYear().toString() + (now.getMonth() < 9 ? "0" + (now.getMonth() + 1).toString() : (now.getMonth() + 1).toString()) + (now.getDate() < 10 ? "0" + now.getDate().toString() : now.getDate().toString()) + (now.getHours() < 10 ? "0" + now.getHours().toString() : now.getHours().toString()) + (now.getMinutes() < 10 ? "0" + now.getMinutes().toString() : now.getMinutes().toString());
				$("#T_contract_num").val(n);
			}
        ...
        function f_selectContact() {
            $.ligerDialog.open({
                ...
                title: '选择客户', width: 600, height: 350, url: '../../crm/Sale/GetCustomerOrder.aspx', buttons: [
        ...
        function f_selectContactOK(item, dialog) {
            ...
            $("#T_Customer").val(data.Customer_name);
            $("#T_Customer_val").val(data.Customer_id);
            $("#T_Order").val(data.order_id);
            $("#T_department").ligerGetComboBoxManager().selectValue(data.C_dep_id, data.C_emp_id);
            //alert(data.C_dep_id + "-" + data.C_emp_id);
            dialog.close();
        }
        /*
        function f_selectContactOK(item, dialog) {
        ...
        */
        ...
        function loadForm(oaid) {
            $.ajax({
                type: "GET",
                url: "../../Data_crm/Crm_contract.ashx", /* 注意后面的名字对应CS的方法名称 */
        ...
        function f_print() {
            //alert('1');
            var tmphtml = window.document.body.innerHTML;
            bstr = "<!--Start-->";
            estr = "<!--End-->";
            tmphtml = tmphtml.substr(tmphtml.indexOf(bstr) + bstr.length);

            //alert("prnhtml:" + prnhtml);

            tmphtml = tmphtml.substring(0, tmphtml.indexOf(estr));
            window.document.body.innerHTML = tmphtml;
            window.print();
            /*
            */
            return tmphtml;
                        ...
                        <table>
                            <tr>
                                ...
                                <td colspan="3">
                                    ...
                                    <input type="hidden" id="T_Order" name="T_Order" />
                                </td>
                            </tr>
                            <tr>
                                <td width="62px">
                            ...
                            <tr>
                                ...
                                <td>
                                   <input type="text" id="T_contract_num" name="T_contract_num" ltype="text" ligerui="{width:182,disabled:true}" validate="{required:true}" /></td>
                                <td width="62px">&nbsp;
                                    </td>
                                <td>&nbsp;
                                    </td>
