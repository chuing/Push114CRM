...
<head>
    ...
    <script src="Js_crm/jquery.jclock.js" type="text/javascript"></script>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            //布局
            $("#layout1").ligerLayout({ leftWidth: 150, rightWidth: 190, bottomHeight: 25, allowBottomResize: false, height: '100%', onHeightChanged: f_heightChanged, isRightCollapse: true });
                ...
                if (yes) {
                    $.ajax({
                        ...
                        success: function (result) {
                            javascript: location.replace("psdin.aspx");
                        }
                    });
                }
            });
        ...
        function show_welcome(item) {
            if (getCookie("xhd_crm_show_wellcome") == 1 || item == 1) {
                var dialog = $.ligerDialog.open({
                    url: "welcome.htm", width: 600, height: 300, title: "欢迎使用广州谱式达系统", buttons: [
                            {
                                text: '关闭', onclick: function (item, dialog) {
                                    dialog.close();
                                }
        ...
        function show_copyright() {
            var dialog = $.ligerDialog.open({
                url: "copyright.html", width: 600, height: 300, title: "版权信息", buttons: [
                        {
                            text: '关闭', onclick: function (item, dialog) {
                                dialog.close();
                            }
...
<body>
    <form id="form1">
        ...
        <div id="layout1" style="width: 100%">
            ...
            <div position="bottom" style="line-height:23px;">广州谱式达</div>
        </div>
        <div id="tipmsg">
