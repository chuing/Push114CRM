    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#maingrid5").ligerGrid({
                ...
                //checkbox:true,
                url: "../Data_crm/Sys_log_Err.ashx?Action=grid",
            ...
            $("#stype").ligerComboBox({ width: 100, url: "../Data_crm/Sys_log_Err.ashx?Action=logtype" })
        ...
        function doserch() {
            ...
            $.ajax({
                url: "../Data_crm/Sys_log_Err.ashx", type: "POST",
                data: serchtxt,
                dataType: 'json',
                beforeSend: function () {
