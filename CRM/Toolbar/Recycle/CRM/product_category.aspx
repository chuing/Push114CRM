    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#maingrid4").ligerGrid({
                ...
                checkbox: true,
                url: "../../../Data_crm/Crm_product_category.ashx?Action=grid&isdel=1&rnd=" + Math.random(),
        ...
        function toolbar() {
            $.getJSON("../../../Data_crm/toolbar.ashx?Action=GetSys&mid=54&rnd=" + Math.random(), function (data, textStatus) {
                //alert(data);
                var items = [];
                var arr = data.Items;
        ...
        function doserch() {
            ...
            manager.setURL("../../../Data_crm/Crm_product_category.ashx?" + serchtxt);
        ...
        function regain() {
            ...
            if (row.length>0) {
                ...
                $.ajax({
                    url: "../../../Data_crm/Crm_product_category.ashx", type: "POST",
