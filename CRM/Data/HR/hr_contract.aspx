    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#maingrid4").ligerGrid({
                ...
                url: "../Data_crm/C_hr_contract.ashx?Action=grid&rnd=" + Math.random(),
        ...
        var view_auth = false;
        function toolbar() {
            $.getJSON("../Data_crm/toolbar.ashx?Action=GetSys&mid=27&rnd=" + Math.random(), function (data, textStatus) {
                //alert(data);
                var items = [];
                var arr = data.Items;
        ...
        function doserch() {
            ...
            manager.setURL("../../Data_crm/C_hr_contract.ashx?" + serchtxt);
        ...
        function del() {
            ...
            if (row) {      
                $.ligerDialog.confirm("删除后不能恢复，\n您确定要删除？", function (yes) {
                    if (yes) {
                        $.ajax({
                            url: "../Data_crm/C_hr_contract.ashx", type: "POST",
