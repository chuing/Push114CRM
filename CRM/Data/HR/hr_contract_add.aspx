...
<head id="Head1">
    ...
    <script type="text/javascript">
        ...
        function initcombo() {
            ...
            b = $('#T_dep').ligerComboBox({
                ...
                onSelected: function (newvalue, newtext, newid) {
                    $.get("../Data_crm/hr_post.ashx?Action=combo&postid=" + newvalue + "&rnd=" + Math.random(), function (data, textStatus) {
                        a.setData(eval(data));
                        a.selectValue(newid);
                    });
                }
            });
            c = $('#T_position').ligerComboBox({ width: 182,url:'../Data_crm/hr_position.ashx?Action=combo&rnd='+Math.random() });
        }
        ...
        function loadForm(oaid) {
            $.ajax({
                type: "GET",
                url: "../Data_crm/C_hr_contract.ashx", /* 注意后面的名字对应CS的方法名称 */
