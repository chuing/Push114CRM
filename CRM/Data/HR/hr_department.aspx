...
<head>
    ...
    <script type="text/javascript" charset="utf-8">
        ...
        $(function () {
            ...
            $.get("../Data_crm/hr_department.ashx?Action=department&did=-2", function (data, textStatus) {
                //alert(data);
        ...
        function toolbar() {
            $.getJSON("../Data_crm/toolbar.ashx?Action=GetSys&mid=21&rnd=" + Math.random(), function (data, textStatus) {
                //alert(data);
                var items = [];
                var arr = data.Items;
        ...
        function onSelect(note) {
            $.get("../Data_crm/hr_department.ashx?Action=department&did=" + note.data.id + '&rdm=' + Math.random(), function (data, textStatus) {
                //alert(data);
                var arrstr = new Array();
                arrstr = data.split(",");
            ...
            if (node) {
                if (manager.isChildren(node)) {
                    ...
                    $.ligerDialog.confirm("角色删除后不能恢复，\n您确定要移除？", function (yes) {
                        if (yes) {
                            $.ajax({
                                url: "../Data_crm/hr_department.ashx", type: "POST",
