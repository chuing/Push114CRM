    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#maingrid4").ligerGrid({
                ...
                url: "../../../Data_crm/CRM_Contact.ashx?Action=grid&isdel=1",
                width: '100%',
                height: '100%',
                //title: "员工列表",
                heightDiff: -1,
        ...
        function toolbar() {
            $.getJSON("../../../Data_crm/toolbar.ashx?Action=GetSys&mid=48&rnd=" + Math.random(), function (data, textStatus) {
                //alert(data);
                var items = [];
                var arr = data.Items;
        ...
        function doserch() {
            ...
            manager.setURL("../../../Data_crm/CRM_Contact.ashx?" + serchtxt);
        ...
        function regain() {
            ...
            if (row.length>0) {
                ...
                $.ajax({
                    url: "../../../Data_crm/CRM_Contact.ashx", type: "POST",
