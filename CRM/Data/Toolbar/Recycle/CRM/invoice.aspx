    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#maingrid4").ligerGrid({
                ...
                checkbox:true,
                url: "../../../Data_crm/CRM_invoice.ashx?Action=grid&isdel=1&rnd=" + Math.random(),
        ...
        function toolbar() {
            $.getJSON("../../../Data_crm/toolbar.ashx?Action=GetSys&mid=53&rnd=" + Math.random(), function (data, textStatus) {
                //alert(data);
                var items = [];
                var arr = data.Items;
        ...
        function doserch() {
            ...
            manager.setURL("../../../Data_crm/C_CRM_invoice.ashx?" + serchtxt);
        ...
        function regain() {
            ...
            if (row.length>0) {
                ...
                $.ajax({
                    url: "../../../Data_crm/CRM_invoice.ashx", type: "POST",
