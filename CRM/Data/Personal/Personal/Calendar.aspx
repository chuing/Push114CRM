...
<head>
    ...
    <link href="../../Css_crm/xgcalendar/main.css" rel="stylesheet" type="text/css" />
    <link href="../../Css_crm/xgcalendar/dailog.css" rel="stylesheet" type="text/css" />
    <link href="../../Css_crm/xgcalendar/calendar.css" rel="stylesheet" type="text/css" />
    <link href="../../Css_crm/xgcalendar/dp.css" rel="stylesheet" type="text/css" />
    <link href="../../Css_crm/xgcalendar/alert.css" rel="stylesheet" type="text/css" />
    <link href="../../Css_crm/xgcalendar/blackbird.css" rel="stylesheet" type="text/css" />
    <style type="text/css">
        <!--
        ...
        #show { background: url(../../img_crm/xgcalendar/photo.jpg); }
...
<body style="margin-top: -1px">
    ...
    <script src="../../Js_crm/xgcalendar/jquery.min.js" type="text/javascript"></script>
    ...
    <script src="../../Js_crm/xgcalendar/datepicker_lang_zh_CN.js" type="text/javascript"></script>
    <script src="../../Js_crm/xgcalendar/jquery.datepicker.js" type="text/javascript"></script>
    <%-- <script src="../../Js_crm/xgcalendar/Common.js" type="text/javascript"></script>
    <script src="../../Js_crm/xgcalendar/blackbird.js" type="text/javascript"></script>
    
    <script src="../../Js_crm/xgcalendar/jquery.alert.js" type="text/javascript"></script>
    <script src="../../Js_crm/xgcalendar/jquery.ifrmdailog.js" defer="defer" type="text/javascript"></script>--%>
    <script src="../../Js_crm/xgcalendar/xgcalendar_lang_zh_CN.js" type="text/javascript"></script>
    <script src="../../Js_crm/xgcalendar/xgcalendar.js?v=1.2.0.4" type="text/javascript"></script>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            var op = {
                ...
                //autoload:true,
                url: "../../Data_crm/Personal_Calendar.ashx?Action=get",
                quickAddUrl: "../../Data_crm/Personal_Calendar.ashx?Action=quickadd",
                quickUpdateUrl: "../../Data_crm/Personal_Calendar.ashx?Action=quickupdate",
                quickDeleteUrl: "../../Data_crm/Personal_Calendar.ashx?Action=quickdel" //快速删除日程的
            ...
            function f_save(item, dialog) {
                ...
                if (issave) {
                    ...
                    $.ajax({
                        url: "../../Data_crm/Personal_Calendar.ashx", type: "POST",
                        data: issave,
