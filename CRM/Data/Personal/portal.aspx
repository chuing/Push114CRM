...
<head>
    ...
    <script src="../Js_crm/FusionCharts/FusionCharts.js" type="text/javascript"></script>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            note();
            report();
            setInterval('autoscroll("#c_notice")', 3000);
        });
        ...
        function notice() {  //公告提醒
            $.getJSON("../Data_crm/public_notice.ashx?Action=noticeremind&rnd=" + Math.random(), function (data, textStatus) {
                var obj = eval(data);
                var table = $("<table style='width:100%'></table>")
                for (var i = 0; i < obj.Rows.length; i++) {
                    $("<tr><td style='width:25px;text-align:center;'><div style='height:18px;padding-top:5px;overflow:hidden;'><img src='../../img_crm/icon/18.png'></div></td><td><div style='overflow:hidden;height:18px;'><a herf='#' onclick=\"window.top.f_addTab('tabid14','公告','Personal/Message/notice.aspx')\">" + obj.Rows[i].notice_title + "</a></div></td><td width='80'>" + formatTimebytype(obj.Rows[i].notice_time, 'yyyy-MM-dd') + "</td></tr>").appendTo(table);
                }
        ...
        function todo() {  //日程安排提醒
            $.getJSON("../Data_crm/Personal_Calendar.ashx?Action=Today&rnd=" + Math.random(), function (data, textStatus) {
                var obj = eval(data);
                var table = $("<table style='width:100%'></table>")
                for (var i = 0; i < obj.Rows.length; i++) {
                    $("<tr><td style='width:25px;text-align:center;'><div style='height:18px;padding-top:5px;overflow:hidden;'><img src='../../img_crm/icon/31.png'></div></td><td><div style='overflow:hidden;height:18px;'><a herf='#' onclick=\"window.top.f_addTab('tabid7','日程安排','personal/personal/Calendar.aspx')\">" + obj.Rows[i].Subject + "</a></div></td><td width='80'>" + formatTimebytype(obj.Rows[i].StartTime, 'yyyy-MM-dd') + "</td></tr>").appendTo(table);
                }
                table.addClass("bodytable2");
        ...
        function news() {  //新闻
            $.getJSON("../Data_crm/public_news.ashx?Action=newsremind&rnd=" + Math.random(), function (data, textStatus) {
                var obj = eval(data);
                var table = $("<table style='width:100%'></table>")
                for (var i = 0; i < obj.Rows.length; i++) {
                    $("<tr><td style='width:25px;text-align:center;'><div style='height:18px;padding-top:5px;overflow:hidden;'><img src='../../img_crm/icon/10.png'></div></td><td><div style='overflow:hidden;height:18px;'><a herf='#' onclick=\"window.top.f_addTab('tabid13','新闻','personal/message/news.aspx')\">" + obj.Rows[i].news_title + "</a></div></td><td width='80'>" + formatTimebytype(obj.Rows[i].news_time, 'yyyy-MM-dd') + "</td></tr>").appendTo(table);
                }
                table.addClass("bodytable2");
        ...
        function note() {  //便签
            $.getJSON("../Data_crm/Personal_notes.ashx?Action=notesremind&rnd=" + Math.random(), function (data, textStatus) {
                var obj = eval(data);
                var table = $("<table style='width:100%'></table>")
                for (var i = 0; i < obj.Rows.length; i++) {
                    $("<tr><td style='width:25px;text-align:center;'><div style='height:18px;padding-top:5px;overflow:hidden;'><img src='../../img_crm/icon/35.png'></div></td><td><div style='overflow:hidden;height:18px;'><a herf='#' onclick=\"window.top.f_addTab('tabid2','便签','personal/personal/notes.aspx')\">" + obj.Rows[i].note_content
        ...
        function report() {
            ...
            $.ajax({
                url: "../Data_crm/Reports_CRM.ashx", type: "POST",
                data: sendtxt,
                dataType: 'json',              
        ...
        function test(GridData) {              
            var chart_myNext = new FusionCharts("../Js_crm/FusionCharts/FCF_MSColumn3DLineDY.swf", "myNext", "670", "200", "0", "0");
