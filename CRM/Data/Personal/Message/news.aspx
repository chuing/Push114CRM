    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#maingrid4").ligerGrid({
                ...
                url: "../../Data_crm/public_news.ashx?Action=grid&rnd=" + Math.random(),
                //title:'公告列表',
        ...
        //工具条实例化
            function toolbar() {
                $.getJSON("../../Data_crm/toolbar.ashx?Action=GetSys&mid=13&rnd=" + Math.random(), function (data, textStatus) {
                    //alert(data);
                    var items = [];
                    var arr = data.Items;
        ...
        function doserch() {
            ...
            manager.setURL("../../Data_crm/public_news.ashx?" + serchtxt);
        ...
        function del() {
            ...
            if (row) {
                ...
                if (yes) {
                    $.ajax({
                        url: "../../Data_crm/public_news.ashx", type: "POST",
