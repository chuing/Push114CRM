    ...
    <script type="text/javascript">
        ...
        function getAtta() {
            var grid = {
                ...
                url: "../../Data_crm/mail.ashx?Action=Get_atta_list&mail_id=" + getparastr("nid"),
                pageSize: 30,
                checkbox: false
            };
            return grid;
        ...
        <table style="margin:2px;border-collapse: collapse;width:738px;">
            <tr>
                <td colspan="2" class="table_title" style="border: 1px solid #b6d6e6; padding: 2px; line-height: 22px;">
                   <div style="width:32px;float:left"><img src="../../img_crm/icons/32X32/email.gif" width="32" height="32" /></div>
