...
<head>
    ...
    <link href="../../Css_crm/swfupload.css" rel="stylesheet" />
    <script type="text/javascript" src="../../Js_crm/swfupload/swfupload.js"></script>
    <script type="text/javascript" src="../../Js_crm/swfupload/swfupload.queue.js"></script>
    <script type="text/javascript" src="../../Js_crm/swfupload/fileprogress.js"></script>
    <script type="text/javascript" src="../../Js_crm/swfupload/filegroupprogress.js"></script>
    <script type="text/javascript" src="../../Js_crm/swfupload/handlers.js"></script>
    ...
    <script type="text/javascript">
        ...
        function initmail() {
            ...
            if (mail_id && mail_id != "null") {
                $.ajax({
                    type: "GET",
                    url: "../../Data_crm/mail.ashx", /* �ע���������ֶ�ӦCS�ķ����� */
        ...
        function swfupload() {
            var settings = {
                flash_url: "../../Js_crm/swfupload/swfupload.swf",
                upload_url: "../../Data_crm/upload.ashx?Action=Mult",
                post_params: {
                ...
                // Button settings
                button_image_url: "img_crm/TestImageNoText_65x29.png",
                button_width: "65",
                button_height: "29",
        ...
        function mail_attachment(file_id, file_name, real_name) {
            ...
            $.ajax({
                url: "../../Data_crm/mail.ashx", type: "POST",
                data:
                {
