        ...
        $(function () {
            ...
            $("#toolbar").ligerToolBar({
                items: [
                    ...
                    { type: 'button', text: '统计', icon: '../../img_crm/search.gif', disable: true, click: function () { doserch(); } },
                    { type: 'button', text: '重置', icon: '../../img_crm/edit.gif', disable: true, click: function () { $("#serchform").each(function () { this.reset(); $(".l-selected").removeClass("l-selected"); }); } }
                ]
                //激活哪个
            });
            initSelect();
        ...
        function doserch() {    
            ...
            $.ajax({
                ...
                success: function (responseText) {
                    manager.setURL("../../Data_crm/Reports_CRM.ashx?" + serchtxt);
