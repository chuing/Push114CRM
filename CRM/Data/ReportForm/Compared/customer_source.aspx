...
</title><meta http-equiv="X-UA-Compatible" content="IE=8" /><link href="../../Css_crm/core.css" rel="stylesheet" type="text/css" /><link href="../../lib/ligerUI/skins/ext/css/ligerui-all.css" rel="stylesheet" type="text/css" /><link href="../../Css_crm/Toolbar.css" rel="stylesheet" type="text/css" /><link href="../../Css_crm/input.css" rel="stylesheet" />
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#maingrid5").ligerGrid({
                ...
                url: '../../Data_crm/CRM_Customer.ashx',
                usePager: false,
            ...
            items.push({ type: 'button', text: '统计', icon: '../../img_crm/search.gif', disable: true, click: function () { doserch() } });
            items.push({ type: 'button', text: '重置', icon: '../../img_crm/edit.gif', disable: true, click: function () { $("#serchform").each(function () { this.reset(); $(".l-selected").removeClass("l-selected"); }); } });
        ...
        function test(GridData) {
            ...
            var chart_myNext = new FusionCharts("../../Js_crm/FusionCharts/FCF_MSColumn3DLineDY.swf", "myNext", "860", "280", "0", "0");
