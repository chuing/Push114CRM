...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../Css_crm/imgareaselect-default.css" />
    <script type="text/javascript" src="../Js_crm/jquery.min.js"></script>
    <script type="text/javascript" src="../Js_crm/jquery.imgareaselect.pack.js"></script>
    ...
    <script type="text/javascript">
        ...
        function uploadimg() {
            ...
            if (type == ".xls" || type == ".xlsx" || type == ".csv" || type == ".txt") {
                $("#form1").ajaxSubmit({
                    type: "post",
                    url: "../Data_crm/upload.ashx", /* 注意后面的名字对应CS的方法名称 */
            ...
            <fieldset>
                ...
                <div style="float: left; width: 500px;">
                    ...
                    <div class="frame" style="margin: 0 0.3em; width: 485px; height: 325px; overflow: auto; z-index: 100">
                        <img id="photo" src="../img_crm/noheadimage.jpg" height="300" />
                    </div>
                ...
                <div style="float: left; width: 200px;">
                    ...
                    <div class="frame" style="margin: 0 1em; width: 120px; height: 120px;">
                        <div id="preview1" style="width: 120px; height: 120px; overflow: hidden;">
                            <img src="../img_crm/noheadimage.jpg" style="width: 120px; height: 120px;" />
                        </div>
                    </div>
