    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#maingrid4").ligerGrid({
                ...
                enabledEdit: true,
                url: "../Data_crm/Sys_role.ashx?Action=grid",
                width: '100%',
                height: '100%',
                heightDiff: -1,
        ...
        function toolbar() {
            $.getJSON("../Data_crm/toolbar.ashx?Action=GetSys&mid=31&rnd=" + Math.random(), function (data, textStatus) {
                //alert(data);
                var items = [];
                var arr = data.Items;
        ...
        function f_reload() {
            ...
            var url = "../Data_crm/Sys_role.ashx?Action=grid";
            ...
            if (row) {
                $.ligerDialog.confirm("角色删除后不能恢复，\n您确定要移除？", function (yes) {
                    if (yes) {
                        $.ajax({
                            type: "POST",
                            url: "../Data_crm/Sys_role.ashx", /* 注意后面的名字对应CS的方法名称 */
        ...
        function f_save(item, dialog) {
            ...
            if (issave) {
                ...
                $.ajax({
                    url: "../Data_crm/Sys_role.ashx", type: "POST",
                    data: issave,
