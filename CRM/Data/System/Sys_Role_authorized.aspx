    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#maingrid4").ligerGrid({
                ...
                enabledEdit: true,
                checkbox: true,
                url: "../Data_crm/System_role_data.ashx?action=treegrid",
        ...
        function onSelect(note) {
            ...
            var url = "../Data_crm/Sys_role.ashx?Action=treegrid&appid=" + note.data.id + '&rdm=' + Math.random();
            ...
            $.ajax({
                type: 'post',
                url: "../Data_crm/Sys_role.ashx?Action=getauth&postdata=" + savetext + '&rdm=' + Math.random(),
        ...
        function f_save() {
            ...
            if (notes != null && notes != undefined) {
                ...
                $.ajax({
                    type: 'post',
                    url: "../Data_crm/Sys_role.ashx?Action=saveauth&postdata=" + savetext + '&rdm=' + Math.random(),
                    success: function (data) {
                        //alert(data);
                        setTimeout(function () {
                            f_success();
        ...
        function gridreload(Appid) {
            ...
            var url = "../Data_crm/Sys_Menu_data.aspx?action=treegrid&appid=" + Appid;
            manager.GetDataByURL(url);
        };
