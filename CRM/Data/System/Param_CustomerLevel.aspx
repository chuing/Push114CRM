    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#maingrid4").ligerGrid({
                ...
                //checkbox:true,
                url: "../Data_crm/Param_CustomerLevel.ashx?Action=grid",
        ...
        function toolbar() {
            $.get("../Data_crm/toolbar.ashx?Action=Get&mid=20&rnd=" + Math.random(), function (data, textStatus) {
                //alert(data);
        ...
        function del() {
            ...
            if (row) {
                if (confirm("删除后不能恢复，\n您确定要删除？")) {
                    $.ajax({
                        type: "POST",
                        url: "../Data_crm/Param_CustomerLevel.ashx", 
        ...
        function f_save(item, dialog) {
            ...
            if (issave) {
                ...
                $.ajax({
                    url: "../Data_crm/Param_CustomerLevel.ashx", type: "POST",
                    data: issave,
