...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $.get("../Data_crm/hr_department.ashx?Action=department&did=1", function (data, textStatus) {
                //alert(data);
        ...
        function toolbar() {
            $.get("../Data_crm/toolbar.ashx?Action=Get&mid=19&rnd=" + Math.random(), function (data, textStatus) {
                //alert(data);
