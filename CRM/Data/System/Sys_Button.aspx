...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#tree1").ligerTree({
                //url: '../Data_crm/Sys_Menu.ashx?Action=GetSysApp&rnd=' + Math.random(),
                url: '../Data_crm/Sys_App.ashx?Action=GetAppList&rnd=' + Math.random(),
                onSelect: onSelect,
                idFieldName: 'id',
                usericon: 'App_icon',
                checkbox: false,
            ...
            $("#maingrid1").ligerGrid({
                ...
                onSelectRow: function (data, rowindex, rowobj) {
                    ...
                    var url = "../Data_crm/Sys_Button.ashx?Action=GetGrid&menuid=" + data.Menu_id + "&rnd=" + Math.random();
                ...
                url: "../Data_crm/Sys_Menu.ashx?Action=GetMenu&parentid=-1",
                width: '100%',
                height: '50%',
                heightDiff: 0
            ...
            $("#maingrid2").ligerGrid({
                ...
                url: "../Data_crm/Sys_Button.ashx?Action=GetGrid&menuid=-1",
                width: '100%',
                height: '100%',
                heightDiff: 0,
        ...
        function toolbar() {
            $.getJSON("../Data_crm/toolbar.ashx?Action=GetSys&mid=59&rnd=" + Math.random(), function (data, textStatus) {
                //alert(data);
                var items = [];
                var arr = data.Items;
        ...
        function onSelect(note) {
            ...
            manager.showData({ Rows: [], Total: 0 });
            var url = "../Data_crm/Sys_Menu.ashx?Action=GetMenu&appid=" + note.data.id + "&rnd=" + Math.random();
            manager.GetDataByURL(url);
        }
        ...
        function batch() {
            ...
            if (row) {
                ...
                var savetext0 = "Action=save&T_btn_name=%E6%96%B0%E5%A2%9E&T_btn_handler=add()&T_btn_icon=../../img_crm/icon/11.png&T_btn_order=10&btnid=&menuid=" + menuid;
                var savetext1 = "Action=save&T_btn_name=%E4%BF%AE%E6%94%B9&T_btn_handler=edit()&T_btn_icon=../../img_crm/icon/33.png&T_btn_order=20&btnid=&menuid=" + menuid;
                var savetext2 = "Action=save&T_btn_name=%E5%88%A0%E9%99%A4&T_btn_handler=del()&T_btn_icon=../../img_crm/icon/12.png&T_btn_order=30&btnid=&menuid=" + menuid;
        ...
        function b_save(issave) {
            if (issave) {
                ...
                $.ajax({
                    url: "../Data_crm/Sys_Button.ashx", type: "POST",
                    data: issave,
