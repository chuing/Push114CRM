...
<head id="Head1">
    ...
    <script type="text/javascript">
        ...
        function initcombo() {
            ...
            e = $('#B_employee').ligerComboBox({ width: 82 });
            f = $('#B_department').ligerComboBox({
                width: 96,
                selectBoxWidth: 240,
                selectBoxHeight: 200,
                valueField: 'id',
                ...
                //readonly: true,
                tree: {
                    url: '../../Data_crm/hr_department.ashx?Action=continue&auth=1&rnd=' + Math.random(),
                    idFieldName: 'id',
                    parentIDFieldName: 'pid',
                    checkbox: false
                },
                    ...
                    <td>
                        <table style="width: 550px">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div style="width: 100px; float: left">
                                        <input id="B_department" name="B_department" type="text" validate="{required:true}" style="width: 97px" />
                                    </div>
                                    <div style="width: 98px; float: left">
                                        <input id="B_employee" name="B_employee" type="text" validate="{required:true}" style="width: 96px" />
                                    </div>
                                </td>
                            </tr>
                            --%>
