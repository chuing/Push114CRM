    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#maingrid4").ligerGrid({
                ...
                //checkbox:true,
                url: "../../Data_crm/CRM_invoice.ashx?Action=grid&rnd=" + Math.random(),
        ...
        function toolbar() {
            $("#toolbar").ligerToolBar({
                items: [
                    { type: 'button', text: '查看发票', icon: '../../img_crm/folder-open.gif', disable: true, click: function () { view(); } },
        ...
        function initSerchForm() {            
            var d = $('#pay_type').ligerComboBox({ width: 196, url: "../../Data_crm/Param_SysParam.ashx?Action=combo&parentid=7&rnd=" + Math.random() });
        ...
        function doserch() {
            ...
            manager.setURL("../../Data_crm/CRM_invoice.ashx?" + serchtxt);
