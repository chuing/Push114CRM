...
<head id="Head1">
    ...
    <script type="text/javascript">
        ...
        function initcombo() {
            d = $('#T_invoice_type').ligerComboBox({ width: 182, url: "../../Data_crm/Param_SysParam.ashx?Action=combo&parentid=7&rnd=" + Math.random() });
        ...
        function loadForm(oaid) {
            $.ajax({
                type: "GET",
                url: "../../Data_crm/CRM_invoice.ashx", /* 注意后面的名字对应CS的方法名称 */
