...
<head id="Head1">
    ...
    <script type="text/javascript">
        ...
        function loadForm(oaid) {
            $.ajax({
                type: "get",
                url: "../../Data_crm/Crm_product.ashx", /* 注意后面的名字对应CS的方法名称 */
                ...
                success: function (result) {
                    ...
                    $("#T_pway_content").val(obj.pway_content);
                    $("#T_price").val(toMoney(obj.price));
                    $("#T_base_price").val(toMoney(obj.base_price));
    ...
    <form id="form1">     
        <table align="left" border="0" cellpadding="3" cellspacing="1" style="width: 462px;">
            ...
            <tr>
                ...
                <td>
                    <div align="right" style="width: 60px">单位：</div>
                </td>
                <td>
            ...
            <tr>
                ...
                <td>
                    <div align="right" style="width: 60px">底价：</div>
                </td>
                <td>
                    <input type='text' id="T_base_price" name="T_base_price" ltype='text' ligerui="{width:160}" /></td>
            </tr>
            ...
            <tr>
                <td style="vertical-align: top">
                    <div align="left" style="width: 54px">渠道：</div>
                </td>
                <td colspan="3">
                    <textarea cols="100" id="T_pway_content" name="T_pway_content" rows="3" class="l-textarea" style="width: 388px"></textarea>
                    <br />
                    注：多个用半角逗号(,)隔开。
                </td>
            </tr>
