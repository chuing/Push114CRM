...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#tree1").ligerTree({
                url: '../../Data_crm/C_product_category.ashx?Action=tree&rnd=' + Math.random(),
                onSelect: onSelect,
                idFieldName: 'id',
            ...
            $("#maingrid4").ligerGrid({
                ...
                url: "../../Data_crm/C_product.ashx?Action=grid",
                width: '100%',
                height: '100%',
                heightDiff: 0
            });
        ...
        function toolbar() {
            $.get("../../Data_crm/toolbar.ashx?Action=GetSys&mid=40&rnd=" + Math.random(), function (data, textStatus) {
                //alert(data);
        ...
        function onSelect(note) {
            ...
            var url = "../../Data_crm/C_product.ashx?Action=grid&categoryid=" + note.data.id + "&rnd=" + Math.random();
