    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#maingrid4").ligerGrid({
                ...
                url: "../../Data_crm/Crm_contract.ashx?Action=grid&rnd=" + Math.random(),
        ...
        var view_auth = false;
        function toolbar() {
            $.getJSON("../../Data_crm/toolbar.ashx?Action=GetSys&mid=35&rnd=" + Math.random(), function (data, textStatus) {
                //alert(data);
                var items = [];
                var arr = data.Items;
        ...
        function f_print(item, dialog) {
            //var ishtml = dialog.frame.f_print();
            //dialog.print;
            /*
            var odoc = dialog.frame.document;
        ...
        <form id='serchform'>
            <table style='width: 750px' class="bodytable1">
                <tr>
                    ...
                    <td>
                        <div style='width: 60px; text-align: right; float: right'>合同编号：</div>
                    </td>
                    <td>
                        <input id='contract_num' name="contract_num" type='text' ltype='text' ligerui='{width:120}' /></td>
                    <td>
                    <td></td>
                    <td></td>
                </tr>
