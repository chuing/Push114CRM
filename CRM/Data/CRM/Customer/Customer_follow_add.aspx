...
<head>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("form").ligerForm();
            $("#T_followtype").ligerComboBox({ width: 196, url: "../../Data_crm/Param_SysParam.ashx?Action=combo&parentid=4&rnd=" + Math.random() })
            if (getparastr("fid")) {
        ...
        function loadForm(oaid) {
            $.ajax({
                type: "GET",
                url: "../../Data_crm/CRM_Follow.ashx", /* 注意后面的名字对应CS的方法名称 */
