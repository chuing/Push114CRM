...
<head>
    ...
    <script type="text/javascript">
                ...
                columns: [
                        ...
                        { display: '客户名', name: 'Customer_name', align: 'left', width: 200 },
                        {
                            display: '跟进内容', name: 'Follow', align: 'left', width: 490, render: function (item) {
                                var html = "<span class='showtip'>" + item.Follow + "</span>";
                                return html;
                            }
                        },
                        {
                        ...
                        {
                            display: '跟进人', name: '', width: 120, render: function (item) {
                                return item.department_name + "." + item.employee_name;
                            }
                        },
                        { display: 'C_id', name: 'Customer_id', width: 60 }
                ],
                dataAction: 'server', pageSize: 30, pageSizeOptions: [20, 30, 50, 100],
                //checkbox:true,
                url: "../../Data_crm/CRM_Follow.ashx?Action=grid",
        ...
        function initSerchForm() {
            var c = $("#followtype").ligerComboBox({ width: 194, url: "../../../Data_crm/Param_SysParam.ashx?Action=combo&parentid=4&rnd=" + Math.random() });
