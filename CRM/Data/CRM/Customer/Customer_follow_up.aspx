...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#maingrid4").ligerGrid({
                columns: [
                    ...
                    {
                        display: '后续跟进', name: '', width: 120, render: function (item) {
                ...
                url: "../../Data_crm/crm_customer.ashx?Action=gridfollowup&rnd=" + Math.random(),
                width: '100%', height: '65%',
                heightDiff: -1,
        ...
        function toolbar() {
            /*
            $.getJSON("../../Data_crm/toolbar.ashx?Action=GetSys&mid=4&rnd=" + Math.random(), function (data, textStatus) {
                //alert(data);
                var items = [];
                var arr = data.Items;
        ...
        function doserch() {
            var sendtxt = "&Action=gridfollowup&rnd=" + Math.random();
