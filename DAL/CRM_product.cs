...
namespace XHD.DAL
{
	...
	public partial class CRM_product
	{
		...
		public bool Update(XHD.Model.CRM_product model)
		{
            ...
            strSql.Append("pway_content=@pway_content");
            ...
            parameters[7].Value = model.price;
            parameters[8].Value = model.base_price;
            parameters[9].Value = model.pway_content;
        ...
        /// 获得渠道数据列表
        /// </summary>
        public DataSet GetModeList(string strWhere)
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select * FROM CRM_product_mode ");
            if (strWhere.Trim() != "")
            {
		...
		{
			StringBuilder strSql=new StringBuilder();
            strSql.Append("select product_id,product_name,category_id,category_name,specifications,status,unit,remarks,price,base_price,isDelete,Delete_time,pway_content ");
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
            ...
            strSql.Append(" product_id,product_name,category_id,category_name,specifications,status,unit,remarks,price,base_price,isDelete,Delete_time,pway_content ");
			strSql.Append(" FROM CRM_product ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
